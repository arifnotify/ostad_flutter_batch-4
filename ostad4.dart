class Car {
  ...
  int year;
  double milesDriven;
  Car(this.brand, this.model, this.year, this.milesDriven) {numberOfCars++; }
  void drive(double miles) {milesDriven += miles;}
double getMilesDriven() {return milesDriven;}
String getBrand() {return brand;}
String getModel() { return model;}
int getYear() {return year;}
  int getAge() {return DateTime.now().year - year;}}
  void main() {
  Car car1 = Car("Toyota", "Camry", 2020, 9000);car1.drive(1000);
  Car car2 = Car("Honda", "Civic", 2018, 6000);car2.drive(2000);
  Car car3 = Car("Ford", "F-150", 2015, 12000);car3.drive(3000);
